 ...
 *---------------------------------------------------------
 */
export const staffAdd = ({mobile,name,userLoginId,roleId,staffCode}) => {
  let data = {
      client_id,client_secret,sign,timestamp,v,mobile,name,userLoginId,roleId,staffCode,password
  }
