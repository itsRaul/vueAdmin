                ...
                <div class="staff">
                    <div class="staff-item">
                        ...
                        <div class="staff-input">
                            <el-input v-model="userloginId" placeholder="单行输入"></el-input>
                        </div>
                    </div>
                    <div class="staff-item">
                    ...
                    <div class="staff-item">
                        ...
                        <div class="staff-input">
                            <el-input v-model="contact" placeholder="单行输入"></el-input>
                        </div>
                    </div>
                    <div class="staff-item">
...
export default {
    ...
    methods: {
        ...
        getStaffAdd() {
            ...
            let userLoginId = this.userloginId
            let roleId = this.roleIdValue
            let staffCode = this.staffCode
            let contact = this.contact //联系方式
            let password = this.password
            staffAdd({contact,name,userLoginId,roleId,staffCode,password}).then(res => {
                if (res.data.code === '0') {
                    this.$message({
